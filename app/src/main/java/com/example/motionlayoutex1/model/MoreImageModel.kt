package com.example.motionlayoutex1.model

import com.example.motionlayoutex1.R

data class MoreImageModel(
    val title: String,
...
val imageDummyData: ArrayList<MoreImageModel> = arrayListOf(
    MoreImageModel(
        "Salmon Salad",
